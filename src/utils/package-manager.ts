 ...
 */
export async function detectPackageManager(cwd: string = process.cwd()): Promise<PackageManagerType> {
  // Check lock files
 ...
 */
export async function isPackageManagerInstalled(pm: PackageManagerType): Promise<boolean> {
  try {
