...
# Build this package
pnpm --filter @pulsar-framework/cli build

# Run tests
pnpm --filter @pulsar-framework/cli test

# Watch mode
pnpm --filter @pulsar-framework/cli dev
```
...
```bash
pnpm --filter @pulsar-framework/cli test
pnpm --filter @pulsar-framework/cli typecheck
pnpm --filter @pulsar-framework/cli lint
```
